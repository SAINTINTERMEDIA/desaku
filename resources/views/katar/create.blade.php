...
<div class="container-fluid">
    <h1 class="mt-4">KARANG TARUNA</h1>
    <ol class="breadcrumb mb-8">
        <li class="breadcrumb-item ative">INPUT DATA KADER</li>
    </ol>
    ...
    <div class="row" >
        <div class="col-12">
            ...
            <form method="POST" action="/katar">
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control  @error('jenis') is-invalid @enderror" id="jenis"  name="jenis" value="KATAR">
